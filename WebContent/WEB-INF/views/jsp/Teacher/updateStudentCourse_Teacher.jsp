...
<body>
	...
	<div style="margin-left: 25%; padding: 1px 16px; height: 1000px;">
		<h1>UPDATE STUDENT COURSE</h1>
		<h3 style="color: red">${error}</h3>

		<form:form action="updateStudentCourse_Teacher" modelAttribute="sc"
			method="post">
			<table>
				<tr>
					<td>Id:</td>
					<td><form:input path="scId" readonly="true" /></td>
				</tr>
				<tr>
					<td>Student Id:</td>
					<td><form:input path="stuId.stuId" readonly="true" /></td>
				</tr>
				<tr>
					<td>Student Name:</td>
					<td><form:input path="stuId.fullName" readonly="true" /></td>
				</tr>
				<tr>
					<td>Course Id:</td>
					<td><form:input path="cId.cId" readonly="true" /></td>
				</tr>
				<tr>
					<td>Mid-Term Mark:</td>
