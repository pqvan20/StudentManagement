...
<body>
	<ul>
		...
		<li><a href="listStudentCourse_Teacher"><i
				class="fas fa-school"></i> Student-Course</a></li>
	...
	<div style="margin-left: 25%; padding: 1px 16px; height: 1000px;">
		...
		<form action="searchStudentCourse_Teacher"
		...
		<form action="studentsInACourse_Teacher"
			style="margin-bottom: 10px; text-align: center">
		...
		<table>
			...
			<c:forEach items="${list}" var="sc">
				<tr>
					...
					<td><a href="detailStudentCourse_Teacher?scId=${sc.scId}">detail</a></td>
					<td><a href="deleteStudentCourse_Teacher?scId=${sc.scId}"
						onclick="return confirm('Are you sure?')">delete</a></td>
				</tr>
			</c:forEach>
		</table>

		<a class="button" href="initInsertSC_Teacher" style="margin: 15px">Add
			New Student into a Course</a>
	</div>
</body>
</html>