	...
	<div style="margin-left: 25%; padding: 1px 16px; height: 1000px;">
		...
		<form:form action="insertStudent" modelAttribute="s" method="post">
			<table>
				...
				<tr>
					<td>Date Of Birth:</td>
					<td><form:input type="date" path="stuDOB" /> <form:errors
							path="stuDOB" cssClass="error"></form:errors></td>

				</tr>
				<tr>
					<td>Gender:</td>
					<td><form:radiobutton value="true" path="gender" />Male <form:radiobutton
							value="false" path="gender" />Female <form:errors path="gender"
							cssClass="error"></form:errors></td>

				</tr>
				<tr>
					<td>phone:</td>
					<td><form:input type="number" path="phone" /> <form:errors
							path="phone" cssClass="error"></form:errors></td>

				</tr>
				<tr>
					<td>Email:</td>
					<td><form:textarea path="mail" /> <form:errors path="mail"
							cssClass="error"></form:errors></td>
