...
<body>
	...
	<div style="margin-left: 25%; padding: 1px 16px; height: 1000px;">
		...
		<form:form action="updateTeacher" modelAttribute="t" method="post">
			<table>

				<tr>
					<td>Teacher Id:</td>
					<td><form:input path="teId" readonly="true" /></td>
				</tr>
				...
				<tr>
					<td>Date Of Birth:</td>
					<td><form:input type="date" path="teDOB" /></td>
				</tr>
				<tr>
					<td>Gender:</td>
					<td><form:radiobutton value="true" path="teGender" />Male <form:radiobutton
							value="false" path="teGender" />Female</td>
				</tr>
				<tr>
					<td>phone:</td>
					<td><form:input type="number" path="tePhone" /></td>
				</tr>
				<tr>
					<td>Email:</td>
					<td><form:textarea path="teMail" /></td>
				</tr>
