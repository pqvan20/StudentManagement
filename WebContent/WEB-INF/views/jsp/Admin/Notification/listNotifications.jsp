		...
		<table>
			...
			<c:forEach items="${list}" var="n">
				<tr>
					...
					<td><a href="detailNotification?notiId=${n.notiId}">detail</a></td>
					<td><a href="deleteNotification?notiId=${n.notiId}"
						onclick="return confirm('Are you sure?')">delete</a></td>
				</tr>
			</c:forEach>
		</table>

		<a class="button" href="initInsertN" style="margin: 15px">Add New Notification</a>
	</div>
</body>
</html>