...
<body>
	...
	<div style="margin-left: 25%; padding: 1px 16px; height: 1000px;">
		...
		<form:form action="updateNotification" modelAttribute="n"
			method="post">
			<table>
				<tr>
					<td>Id:</td>
					<td><form:input path="notiId" readonly="true" /></td>
				</tr>
				<tr>
					<td>Date:</td>
					<td><form:input type="date" path="notiDate" /></td>
				</tr>
				<tr>
					<td>Notification:</td>
					<td><form:textarea path="notification" /></td>
				</tr>
				<tr>
					<td></td>
