...
<body>
	...
	<div style="margin-left: 25%; padding: 1px 16px; height: 1000px;">
		...
		<form action="searchCourseById" style="margin-bottom: 10px; text-align: center">
			<input type="text" name="id"> <input type="submit"
				value="search by id">
		</form>
		
		<form action="searchCoursesByName" style="margin-bottom: 10px; text-align: center">
		...
		<table>
			...
			<c:forEach items="${list}" var="c">
				<tr>
					...
					<td>${c.teId.teId}</td>
					<td>${c.cost}</td>
					<td><a href="detailCourse?cId=${c.cId}">detail</a></td>
					<td><a href="deleteCourse?cId=${c.cId}"
						onclick="return confirm('Are you sure?')">delete</a></td>
				</tr>
			</c:forEach>
		</table>

		<a class="button" href="initInsertC" style="margin: 15px">Add New Course</a>
	</div>
</body>
</html>