...
<body>
	...
	<div style="margin-left: 25%; padding: 1px 16px; height: 1000px;">
		...
		<form:form action="insertAccount" modelAttribute="a" method="post">
			<table>
				<tr>
					<td>User Name:</td>
				...
				<tr>
					<td>Status:</td>
					<td><form:radiobutton value="true" path="status" />Admin<form:radiobutton
							value="false" path="status" />Teacher</td>
				</tr>
				<tr>
					<td></td>
